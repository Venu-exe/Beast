...
const char *default_subs[] = {
    ...
    "stage", "uat", "qa", "blog", "shop", "store", "portal", "vpn", "ns1",
    "ns2", "ns3", "m", "mobile", "secure", "cpanel", "webmail", "remote",
    "app", "apps", "beta", "demo", "docs", "git", "gitlab", "github",
    "jenkins", "jira", "confluence", "internal", "intranet", "extranet",
    "old", "new", "support", "status", "cdn", "static", "img", "images",
    "assets", "media", "files", "download", "downloads", "forum",
    "community", "chat", "mx", "smtp", "pop", "imap", "autodiscover",
    "autoconfig", "auth", "sso", "login", "signin", "dashboard", "panel",
    "admin-panel", "monitor", "grafana", "kibana", "prometheus", "metrics",
    "logs", "db", "database", "sql", "mysql", "postgres", "redis", "cache",
    "elastic", "search", "api-dev", "api-staging", "api-test", "api-v1",
    "api-v2", "graphql", "ws", "websocket", "socket", "gateway", "proxy",
    "lb", "cdn2", "edge", "origin", "backup", "build", "ci", "cd",
    "release", "preview", "sandbox", "lab", "labs", "research", "partners",
    "partner", "vendor", "customer", "client", "clients", "account",
    "accounts", "billing", "payment", "payments", "checkout", "cart",
    "order", "orders", "shipping", "help", "faq", "kb", "wiki", "docs2",
    "developer", "developers", "dev-portal", "console", "manage",
    "management", "control", "cp", "webadmin", "sysadmin", "root",
    "server", "servers", "host", "hosting", "cloud", "aws", "azure", "gcp",
    "k8s", "kubernetes", "docker", "registry", "npm", "pypi", "maven",
    "artifactory", "nexus", "sonar", "sonarqube", "vault", "secrets",
    "config", "configs", "env", "staging2", "uat2", "demo2", "test2",
    "beta2", "alpha", "canary", "green", "blue", "prod", "production",
    "live", "www2", "old-www", "legacy", "archive", "static2", "img2",
    "video", "videos", "stream", "streaming", "live-stream", "podcast",
    "news", "press", "careers", "jobs", "recruiting", "hr", "finance",
    "legal", "investors", "ir", "about", "contact", "sales", "marketing",
    "crm", "erp", "sap", "oracle", "salesforce", "zendesk", "freshdesk",
    "intercom", "hubspot", "mailchimp", "sendgrid", "twilio", "stripe",
    "paypal",
    NULL
};
